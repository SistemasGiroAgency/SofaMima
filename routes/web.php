...
Route::post('/correo', [App\Http\Controllers\EMAILController::class, 'correo'])->name('correo');
Route::post('/preguntas', [App\Http\Controllers\EMAILController::class, 'preguntas'])->name('preguntas');
