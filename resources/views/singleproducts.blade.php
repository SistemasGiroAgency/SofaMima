          ...
          <div class="col-md-5">
            <div class="product-info">
              <div class="element-header">
                <h2 itemprop="name" class="display-4 fw-bold" style="font-size: 3vh;">{{$singleproduct->nombre}}</h2>
              </div>
              ...
              <div class="product-action mt-4">
                <div class="product-quantity d-flex flex-wrap gap-3">
                  <div class="cate-links d-flex flex-column mt-4">
                    ...
                    <a href="/contacto"><button class="custom-btn btn-15 text-uppercase">Me interesa</button></a>
                  </div>
                </div>
              </div>
            </div>
