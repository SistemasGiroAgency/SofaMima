  ...
  <main class="main-content mt-5 py-5">
    <div class="container">
      <nav class="breadcrumb mt-5">
        ...
        <a class="breadcrumb-item" href="/catalogo">Catálogo</a>
        <span class="breadcrumb-item active" aria-current="page">{{$singleproduct->nombre}}</span>
      </nav>
    </div>
            ...
            <div class="row flex-column-reverse flex-lg-row">
                ...
                <div class="swiper product-thumbnail-slider vertical" data-num="6" data-direction="vertical">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="{{asset('images/admin/' . $singleproduct->imguno)}}" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{asset('images/admin/' . $singleproduct->imgdos)}}" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{asset('images/admin/' . $singleproduct->imgtres)}}" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{asset('images/admin/' . $singleproduct->imgcuatro)}}" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                    <div class="swiper-slide">
                      <img src="{{asset('images/admin/' . $singleproduct->imgcinco)}}" alt="thumb-image" class="thumb-image img-fluid">
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-lg-10">
                <div class="swiper product-large-slider">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="{{asset('images/admin/' . $singleproduct->imguno)}}"><img
                          src="{{asset('images/admin/' . $singleproduct->imgseis)}}" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="{{asset('images/admin/' . $singleproduct->imgdos)}}"><img
                          src="{{asset('images/admin/' . $singleproduct->imgsiete)}}" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="{{asset('images/admin/' . $singleproduct->imgtres)}}"><img
                          src="{{asset('images/admin/' . $singleproduct->imgocho)}}" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="{{asset('images/admin/' . $singleproduct->imgcuatro)}}"><img
                          src="{{asset('images/admin/' . $singleproduct->imgnueve)}}" alt="product-large" class="img-fluid"></div>
                    </div>
                    <div class="swiper-slide">
                      <div class="image-zoom" data-scale="2.5" data-image="{{asset('images/admin/' . $singleproduct->imgcinco)}}"><img
                          src="{{asset('images/admin/' . $singleproduct->imgdiez)}}" alt="product-large" class="img-fluid"></div>
                    </div>
                  </div>
          ...
          <div class="col-md-5">
            <div class="product-info">
              <div class="element-header">
                <h2 itemprop="name" class="display-4 fw-bold">{{$singleproduct->nombre}}</h2>
              </div>
                  ...
                  <div class="cate-links d-flex flex-column mt-4">
                    <div class="cate-tag d-flex mb-3">
                      <div class="tag-item d-flex">
                        ...
                        <div class="container-fluid p-0">
                          <div class="row">
                            <div class="col-12">
                              Categoría: {{$singleproduct->categoria}}
                            </div>
                            <div class="col-12">
                        ...
                        <div class="container-fluid p-0">
                          <div class="row">
                            ...
                            <div class="col-12">
                              Medidas: {{$singleproduct->material}}
                            </div>
                          </div>
                        </div>
                        @endif
                    ...
                    <div class="social-links d-flex align-items-center gap-2 mb-3">
                      ...
                      <ul class="list-unstyled d-flex gap-2 m-0 lh-1">
                        <li>
                          <a href="https://www.facebook.com/Mueblesmima/" class="text-secondary p-0">
                        ...
                        <li>
                          <a href="https://www.youtube.com/@SofaMima" class="text-secondary p-0">
                            <svg width="18" height="18">
                        ...
                        <li>
                          <a href="https://www.instagram.com/sofamima/?hl=es-la" class="text-secondary p-0">
                            <svg width="18" height="18">
          ...
          <div class="tabs-listing">
            ...
            <div class="tab-content py-5" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                <p>{{$singleproduct->infoadicional}}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="related-products" class="related-products py-5">
      <div class="container-fluid">
        <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
          <h4 class="text-uppercase"><b>Productos relacionados</b></h4>
          <a href="/catalogo" class="btn-link">SÉ EL PRIMERO EN VERLO</a>
        </div>
            ...
            <div class="col">
              <div class="product-item hover-effect-slide tarjetaresponsive">
                <div class="image-holder position-relative">
                  <a href="/{{$productos->id}}/singleproducts">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img width="247" height="64" src="{{asset('images/logosofamima.png')}}" alt="">
              </a>
            </div>
