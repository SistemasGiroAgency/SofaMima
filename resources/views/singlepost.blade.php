...
<body class="homepage">
  ...
  <div class="text-white fs-6 text-uppercase overflow-hidden"></div>
  ...
  <div class="post-wrap pb-5">
    <div class="container">
      <div class="row g-5">
        <main class="post-grid col-md-8 offset-md-2">
          
          <div class="row text-center mt-5 py-5">
            
            <nav class="breadcrumb justify-content-center mt-5">
            ...
            <div class="post-meta text-uppercase">
              <span class="post-category">Fashion</span> / <span class="meta-date">{{$post->fecha}}</span>
            </div>
          ...
          <div class="row">
            <article class="post-item">
              <div class="hero-image">
                <img src="{{ asset('images/' . $post->imguno) }}" alt="single-post" class="img-fluid">
              </div>
              <div class="post-content py-5">
                <div class="post-description">
                  <p>{{$post->textouno}}</p>
                  <p>{{$post->textodos}}</p>
                  <blockquote><b>{{$post->textotres}}</b></blockquote>
                  <img src="{{ asset('images/' . $post->imgdos) }}" alt="post-image" class="img-fluid mb-4">
                  <p>{{$post->textocuatro}}</p>
                  <p>{{$post->textocinco}}</p>
                  <p>{{$post->textoseis}}</p>
                  <p>{{$post->textosiete}}</p>
                  <div class="post-bottom-link d-flex justify-content-between">
                    <div class="block-tag">
                      <ul class="list-unstyled d-flex gap-2">
                        <li>
                          <a href="#" class="btn btn-light">salas</a>
                        </li>
                        <li>
                          <a href="#" class="btn btn-light">noticias</a>
                        </li>
                        <li>
                          <a href="#" class="btn btn-light">consejos</a>
                        </li>
                        <li>
                          <a href="#" class="btn btn-light">elegancia</a>
                        </li>
                        <li>
                          <a href="#" class="btn btn-light">decoración</a>
                        </li>
                      </ul>
                    </div>
                    <div class="block-social-links d-flex align-items-baseline">
                      ...
                      <ul class="list-unstyled d-flex gap-2">
                        <li>
                          <a href="https://www.facebook.com/Mueblesmima/" class="btn btn-light">Facebook</a>
                        </li>
                        <li>
                          <a href="https://www.instagram.com/sofamima/?hl=es-la" class="btn btn-light">Instagram</a>
                        </li>
                      </ul>
                    </div>
                  </div>
