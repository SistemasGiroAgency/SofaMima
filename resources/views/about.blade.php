...
<body class="homepage">
    ...
    <div class="container">
      <div class="row">
        <div class="d-flex flex-wrap flex-column justify-content-between align-items-center mt-5">
          <h1 class="display-5 fw-bold responsiveabouttittle">Diseñando Calidad desde 1970</h1>
  ...
  <section class="py-5" style="padding-top: 1rem !important;">
    <div class="container">
      <div class="row" style="text-align: center;">
        <h3 style="margin-bottom: 5vh;"><b>Con más de 50 años de experiencia, nos hemos consolidado <br> como líderes en la fabricación de salas y sofás.</b></h3>
    ...
    <div class="container">
      <div class="row">
        <div class="video-content" data-aos="fade-in">
          <div class="video-bg">
            <iframe width="100%" height="688" src="https://www.youtube.com/embed/0mS-0LZXRCY?si=wzEBnlSYQGmKDUSW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="testimonials py-5" id="reseñas">
    <div class="section-header text-center mt-5">
      <h3>Reseñas</h3>
    </div>
    <div class="container-fluid pb-5">
      <div class="swiper testimonial-swiper text-dark overflow-hidden my-5 pb-5" style="margin-bottom: 0 !important;">
