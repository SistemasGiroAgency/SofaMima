      ...
      <div class="row">
        <div class="d-flex flex-wrap flex-column justify-content-between align-items-center mt-5">
          ...
          <nav class="breadcrumb">
            ...
            <span class="breadcrumb-item active" aria-current="page">Preguntas F.</span>
          </nav>
        </div>
      </div>
    </div>
  ...
  <section class="faqs-wrap py-5 no-padding-bottom">
    <div class="container">
      <div class="row g-5">
              ...
              <div class="accordion-item mb-3">
                <div class="accordion-header" id="heading-one">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-one" aria-expanded="true" aria-controls="collapse-one">
                    <h3 class="accordion-title">¿Qué hace especiales a las salas de su colección en comparación con otras opciones del mercado?</h3>
                  </button>
                </div>
                  ...
                  <div class="accordion-body">
                    <div class="faqs-box">
                      <div class="element-box margin-xsmall d-flex align-items-center">
                        <div class="item-title">Nuestras salas se distinguen por su calidad superior y diseño único, enfocados en la durabilidad y la comodidad. Cada pieza es creada con atención al detalle, desde la elección de telas hasta la construcción de las estructuras, asegurando que cada sala no solo sea estéticamente atractiva, sino también práctica y duradera para el uso diario.</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="accordion-item mb-3">
                <div class="accordion-header" id="heading-two">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-two" aria-expanded="true" aria-controls="collapse-two">
                    <h3 class="accordion-title">¿Cómo garantizan la durabilidad de sus sofás?</h3>
                  </button>
                </div>
                <div id="collapse-two" class="accordion-collapse collapse" aria-labelledby="heading-two">
                  <div class="accordion-body">
                    <div class="faqs-box">
                      <div class="element-box margin-xsmall d-flex align-items-center">
                        <div class="item-title">La durabilidad es una prioridad para nosotros. Utilizamos materiales de alta calidad y técnicas de fabricación avanzadas para asegurar que cada sofá resista el paso del tiempo y el uso diario.</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="accordion-item mb-3">
                <div class="accordion-header" id="heading-three">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-three" aria-expanded="true" aria-controls="collapse-three">
                    <h3 class="accordion-title">¿Ofrecen opciones de personalización para las salas?</h3>
                  </button>
                </div>
                <div id="collapse-three" class="accordion-collapse collapse" aria-labelledby="heading-three">
                  <div class="accordion-body">
                    <div class="faqs-box">
                      <div class="element-box margin-xsmall d-flex align-items-center">
                        <div class="item-title">Sí, ofrecemos personalización en nuestras salas. Puedes elegir entre una variedad de telas, colores y detalles para que tu sala refleje tu estilo personal.</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="accordion-item mb-3">
                <div class="accordion-header" id="heading-four">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-four" aria-expanded="true" aria-controls="collapse-four">
                    <h3 class="accordion-title">¿Qué tipo de mantenimiento requieren sus salas?</h3>
                  </button>
                </div>
                <div id="collapse-four" class="accordion-collapse collapse" aria-labelledby="heading-four">
                  <div class="accordion-body">
                    <div class="faqs-box">
                      <div class="element-box margin-xsmall d-flex align-items-center">
                        <div class="item-title">Recomendamos una limpieza regular con productos suaves para mantener la apariencia y calidad de nuestras salas. Proporcionamos instrucciones específicas de cuidado con cada compra.</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="accordion-item mb-3">
                <div class="accordion-header" id="heading-five">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-five" aria-expanded="true" aria-controls="collapse-five">
                    <h3 class="accordion-title">¿Cómo puedo comprobar la comodidad de sus sofás antes de comprar?</h3>
                  </button>
                </div>
                <div id="collapse-five" class="accordion-collapse collapse" aria-labelledby="heading-five">
                  <div class="accordion-body">
                    <div class="faqs-box">
                      <div class="element-box margin-xsmall d-flex align-items-center">
                        <div class="item-title">Te invitamos a visitar nuestro showroom ubicado en Plaza Encino para experimentar la comodidad y calidad de nuestros sofás. También ofrecemos asesoría personalizada para ayudarte a elegir el sofá perfecto para tu hogar.</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="inquiry-item col-md-5">
          <h3 class="section-title" style="margin-bottom: 4vh;"><b>Tienes otra pregunta, envíala por este formulario</b></h3>
          <form id="form" action="{{route('preguntas')}}" class="form-group flex-wrap" method="POST">
            @csrf
            ...
            <div class="col-lg-12 mb-3">
              <textarea name="pregunta" placeholder="Pregunta" class="form-control ps-3" rows="8"></textarea>
            </div>
            <div class="d-grid">
