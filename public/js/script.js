(function ($) {
  ...
  var initScrollNav = function() {
    ...
    if (scroll >= 200) {
      ...
      $('.nav-link').addClass("nav-linkblanco");
      $('.imglogo').addClass("imglogoblanco");
      $('.menuburg').addClass("menuburgblanco");
      $('.navbar-toggler').addClass("navbar-togglerdos");
      $('.offcanvas').addClass("offcanvasnegro");
      $('.closenav').addClass("closenavblanco");
      $('.offcanvas-title').addClass("offcanvas-titleblanco");
    }else{
      $('.navbar.fixed-top').removeClass("bg-black");
      $('.nav-link').removeClass("nav-linkblanco");
      $('.imglogo').removeClass("imglogoblanco");
      $('.menuburg').removeClass("menuburgblanco");
      $('.navbar-toggler').removeClass("navbar-togglerdos");
      $('.offcanvas').removeClass("offcanvasnegro");
      $('.closenav').removeClass("closenavblanco");
      $('.offcanvas-title').removeClass("offcanvas-titleblanco");
    }
  }
